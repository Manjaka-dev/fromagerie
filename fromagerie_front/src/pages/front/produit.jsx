...
import { Search, Calendar, BarChart3, TrendingUp, Package, Truck, Settings, Factory, MoreHorizontal } from 'lucide-react';
import './produit.css'
const Produit = () => {
  ...
  const stockData = [
    {
      id: 'FIG-123',
      matieresPremiere: 'Task 1',
      datePeremption: 'Dec 5',
      dateFabrication: 'Dec 5',
      hasMenu: false
    },
    {
      id: 'FIG-122',
      matieresPremiere: 'Task 2',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: false
    },
    {
      id: 'FIG-121',
      matieresPremiere: 'Write blog post for demo day',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: false
    },
    {
      id: 'FIG-120',
      matieresPremiere: 'Publish blog page',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: true
    },
    {
      id: 'FIG-119',
      matieresPremiere: 'Add gradients to design system',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: false
    },
    {
      id: 'FIG-118',
      matieresPremiere: "Responsive behavior doesn't work on Android",
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: false
    },
    {
      id: 'FIG-117',
      matieresPremiere: 'Confirmation states not rendering properly',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: false
    },
    {
      id: 'FIG-116',
      matieresPremiere: 'Text wrapping is awkward on older iPhones',
      datePeremption: 'Dec 5',
      dateFabrication: '',
      hasMenu: true
    }
      ...
      <div className="flex-1 p-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Stock Matières Premières</h2>
          </div>
