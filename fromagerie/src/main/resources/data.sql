...
('Biscuit amande', 150.00, 3.50, 2.00, 'Farine, sucre, amandes, beurre, oeufs', 'Gluten, fruits à coque, lait, oeufs', '2023-12-31', 1),
...
(3, 1, '2023-11-11', 'Marseille centre');
...
-- Supprimer les donnees des tables et reinitialiser les IDs
...
-- Reactiver les contraintes de cle etrangère
