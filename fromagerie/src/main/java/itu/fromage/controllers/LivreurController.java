...
public class LivreurController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> updateLivreur(@PathVariable Integer id, @RequestBody Livreur livreur) {
        try {
            livreur.setId(id);
            // Note: Ajouter une méthode save dans LivraisonService si nécessaire
            Map<String, Object> response = new HashMap<>();
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Map<String, Object>> deleteLivreur(@PathVariable Integer id) {
        try {
